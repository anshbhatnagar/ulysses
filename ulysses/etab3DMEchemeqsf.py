...
#@jit
def fast_RHS(y0,lna,M1,M2,M3,mPhi,Th,gst,gN,GCF,V,eps1tt,eps1mm,eps1ee,eps1tm,eps1te,eps1me,eps2tt,eps2mm,eps2ee,eps2tm,eps2te,eps2me,eps3tt,eps3mm,eps3ee,eps3tm,eps3te,eps3me, C, W, d1,invd1,d2,d3,w1,w2,w3,n1eq,n2eq,n3eq):
...
class EtaB_3DMEsf(ulysses.ULSBase):
    ...
    def RHS(self, y0, lna, nN_int, V, ETA, _C, K, _W):
        ...
        if self.evolEnd:
            ...
            return fast_RHS(y0,lna,self.M1,self.M2,self.M3,self.mPhi,Th,self.ipol_gstar(Tsm),self.gN,self.GCF,V,eps1tt,eps1mm,eps1ee,eps1tm,eps1te,eps1me,eps2tt,eps2mm,eps2ee,eps2tm,eps2te,eps2me,eps3tt,eps3mm,eps3ee,eps3tm,eps3te,eps3me, C, W,
